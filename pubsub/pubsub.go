...
func (s *PubSub) curGopCacheSnapshot() *gopCacheSnapshot {
...
func (s *PubSub) AddSub(close <-chan bool, w av.PacketWriter) {
	ss := &streamSub{
...
func (s *PubSub) SetPub(r av.PacketReader) {
